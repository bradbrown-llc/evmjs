interface EjraNode {
    ...
    getBalance: (data:string, tag:Tag) => Promise<bigint>
    ...
    getStorageAt: (address:string, slot:bigint, tag:Tag) => Promise<string>
    
    /** Returns the number of transactions sent from an address.
      * @param address - address
      * @param tag - see {@link Tag}
      * @returns integer of the number of transactions send from this address. */
    getTransactionCount: (address:string, tag:Tag) => Promise<bigint>
    
    /** Returns the number of transactions in a block from a block matching the given block hash.
      * @param hash - hash of a block
      * @returns integer of the number of transactions in this block. */
    getBlockTransactionCountByHash: (hash:string) => Promise<bigint>
    
    /** Returns the number of transactions in a block matching the given block number.
      * @param tag - see {@link Tag}
      * @returns integer of the number of transactions in this block. */
    getBlockTransactionCountByNumber: (tag:Tag) => Promise<bigint>
    
    /** Returns the number of uncles in a block from a block matching the given block hash.
      * @param hash - hash of a block
      * @returns integer of the number of uncles in this block. */
    getUncleCountByBlockHash: (hash:string) => Promise<bigint>
    
    /** Returns the number of uncles in a block from a block matching the given block number.
      * @param tag - see {@link Tag}
      * @returns integer of the number of uncles in this block. */
    getUncleCountByBlockNumber: (tag:Tag) => Promise<bigint>
    ...
    estimateGas: (tx:TxEstimateGas) => Promise<bigint>
    ...
    getBlockByNumber: (tag:Tag, full:boolean) => ReturnType<EjraNode['getBlockByHash']>
    ...
    getTransactionByBlockHashAndIndex: (hash:string, index:bigint) => ReturnType<EjraNode['getTransactionByHash']>
    
    /** Returns information about a transaction by block number and transaction index position.
      * @param tag - see {@link Tag}
      * @param index - the transaction index position.
      * @returns see {@link getTransactionByHash} */
    getTransactionByBlockNumberAndIndex: (tag:Tag, index:bigint) => ReturnType<EjraNode['getTransactionByHash']>
    ...
    /** Returns information about a uncle of a block by hash and uncle index position.
      ...
      * @returns see {@link getBlockByHash} */
    getUncleByBlockHashAndIndex: (hash:string, index:bigint) => ReturnType<EjraNode['getBlockByHash']>
    
    /** Returns information about a uncle of a block by number and uncle index position.
      * @param tag - see {@link Tag}
      * @param index - the uncle's index position.
      * @returns see {@link getBlockByHash} */
    getUncleByBlockNumberAndIndex: (tag:Tag, index:bigint) => ReturnType<EjraNode['getBlockByHash']>
    ...
    /** Creates a filter object, based on filter options, to notify when the state changes (logs). To check if the state has changed, call {@link getFilterChanges}.
      ...
      * @returns A filter id. */
    newFilter: (filter:FilterNew) => Promise<bigint>
    ...
    uninstallFilter: (id:bigint) => () => Promise<boolean>
    ...
    getFilterLogs: (id:bigint) => ReturnType<EjraNode['getFilterChanges']>
    
    /** Returns an array of all logs matching a given filter object.
      * @param filter - The filter options. See {@link Filter}
      * @returns see {@link getFilterChanges} */
    getLogs: (filter:Filter) => ReturnType<EjraNode['getFilterChanges']>
