...
/** @prop removed - true when the log was removed, due to a chain reorganization. false if its a valid log.
  ...
  * @prop blockNumer - the block number where this log was in. null when its pending. null when its pending log.
...
interface EJRA {
    ...
    syncing: Promise<false|SyncData>
    ...
    getBlockByNumber: (tag:Tag, full:boolean) => Promise<Block>
    ...
    getTransactionByBlockHashAndIndex: (hash:string, index:bigint) => Promise<TxGetBy|null>
    
    /** Returns information about a transaction by block number and transaction index position.
      * @param tag - see {@link Tag}
      * @param index - the transaction index position.
      * @returns see {@link getTransactionByHash} */
    getTransactionByBlockNumberAndIndex: (tag:Tag, index:bigint) => Promise<TxGetBy|null>
    ...
    /** Returns information about a uncle of a block by hash and uncle index position.
      ...
      * @returns see {@link getBlockByHash} */
    getUncleByBlockHashAndIndex: (hash:string, index:bigint) => Promise<Block>
    
    /** Returns information about a uncle of a block by number and uncle index position.
      * @param tag - see {@link Tag}
      * @param index - the uncle's index position.
      * @returns see {@link getBlockByHash} */
    getUncleByBlockNumberAndIndex: (tag:Tag, index:bigint) => Promise<Block>
    ...
    getFilterChanges: Promise<string[]|Log[]>
    
    /** Returns an array of all logs matching filter with given id.
      * @param id - The filter id.
      * @returns see {@link getFilterChanges} */
    getFilterLogs: (id:bigint) => Promise<Log[]>
