interface EjraRpc {
    ...
    getTransactionByBlockHashAndIndex: (hash:string, index:string) => ReturnType<EjraNode['getTransactionByHash']>
    
    /** Returns information about a transaction by block number and transaction index position.
      * @param tag - see {@link Tag}
      * @param index - the transaction index position.
      * @returns see {@link getTransactionByHash} */
    getTransactionByBlockNumberAndIndex: (tag:Tag, index:string) => ReturnType<EjraNode['getTransactionByHash']>
    ...
    /** Returns information about a uncle of a block by hash and uncle index position.
      ...
      * @returns see {@link getBlockByHash} */
    getUncleByBlockHashAndIndex: (hash:string, index:string) => ReturnType<EjraNode['getBlockByHash']>
    
    /** Returns information about a uncle of a block by number and uncle index position.
      * @param tag - see {@link Tag}
      * @param index - the uncle's index position.
      * @returns see {@link getBlockByHash} */
    getUncleByBlockNumberAndIndex: (tag:Tag, index:string) => ReturnType<EjraNode['getBlockByHash']>
    ...
    getFilterLogs: (id:string) => ReturnType<EjraNode['getFilterChanges']>
